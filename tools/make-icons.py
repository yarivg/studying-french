...
The icon is the tricolore as a book spine: a navy field with the three bands
inset, so it still reads as "French notebook" at 48px and survives the circular
mask Android applies to maskable icons.
...
def make(size, pad_ratio):
    """pad_ratio is the navy margin around the bands, as a fraction of the size."""
