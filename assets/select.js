/* ============================================================
   select.js — highlight any French on any page, hear it, say it.
...
window.Selected = (function () {
  ...
  // Long enough for a sentence or two of French, short enough that
  ...
  function current() {
    ...
    if (!/[a-zà-öø-ÿ]/i.test(s)) return null;
